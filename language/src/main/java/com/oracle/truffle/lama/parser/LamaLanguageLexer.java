...
public class LamaLanguageLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"WHITESPACE", "NOP", "IF", "THEN", "ELSE", "ELIF", "FI", "CASE", "OF", 
			"ESAC", "WHILE", "DO", "OD", "FOR", "LET", "IN", "VAR", "FUN", "TRUE", 
			"FALSE", "STRING", "CHARACTER", "INTEGER", "LIDENT", "UIDENT", "OP_ASSN1", 
			"OP_ASSN2", "OP_OR", "OP_AND", "OP_CMP", "OP_ADD", "OP_MUL", "LPAR", 
			"RPAR", "LBRKT", "RBRKT", "LCB", "RCB", "COMMA", "CLN", "SCLN", "SQUOTE", 
			"DQUOTE", "DOT", "ALIAS", "RARROW", "VBAR", "ASSERT_VAL", "ASSERT_FUN", 
			"ASSERT_STR"
		};
	}
